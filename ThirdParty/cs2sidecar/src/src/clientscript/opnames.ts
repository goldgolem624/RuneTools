export const rs3opnames: Record<number, string> = {
    ...
    "10257": "DBQUERY_FIND_VALUE",//classic op 733
    ...
    "10364": "DBQUERY_AND",//classic op 735, client opcode 1364: predicate FUN_1400acc10 returns 1 only if EVERY child matches
    ...
    "10385": "DBQUERY_FIND_STRING",//classic op 737
    ...
    "10404": "DBQUERY_NOT",//classic op 734, client opcode 688: predicate FUN_140150100 is SETZ on the single child -> !child.matches(row)
    "10405": "DBQUERY_FILTER_FIELD_OP",//classic op 738, client opcode 2263: (referenceField, valueField, operationId) per-row field-vs-field compare; arg names from the client error strings
    ...
    "10649": "DBQUERY_EXECUTE_COUNT",//classic op 732
