...
(function () {
  ...
  // Reward names from enum 10993, thresholds from enum 10999; identical per faction.
  const REP_TIERS = [
  ...
  // --- Menaphos: rank names enum 12670, thresholds enum 12669 (City Reputation) and 12668 (district).
