...
// Spliced inline into client.html; bare classic script sharing one global scope.
  ...
  let farmData = null, farmFetching = false, farmSig = '', _farmAt = 0;
  ...
  function farmPatch(vbid, enumId) {
    const def = FARM.vb[vbid]; if (!def) return null;
