...
// Spliced inline into client.html at load; bare classic script sharing the global scope.

  let ssKeybind = 0;          // bound virtual-key code, 0 = unbound
  let ssCapturing = false;    // armed "press a key" state (the global keydown guard checks this)
