...
Object.assign(window, { buildCategoryTasks, fetchAreaTasks, renderTaskScaffold });
registerTab({ id: 'areatasks', render: renderAreaTasks, open: function () { areaState.sig = ''; fetchAreaTasks(true); } });
})();
